        ...
        <div className={styles.dropdown} role="listbox">
          ...
          <div className={styles.dropdownSection}>
            <div className={styles.sectionLabel}>
              <span>S-Theme</span>
              <span className={styles.sectionBadge}>Alt</span>
            </div>
            {THEMES.filter(t => t.family === 's-theme').map((t) => (
              <button
                key={t.id}
                className={`${styles.themeOption} ${theme === t.id ? styles.active : ''} ${styles.sThemeOption}`}
                onClick={() => handleSelectTheme(t.id)}
                role="option"
                aria-selected={theme === t.id}
              >
