...
import { deleteProject, deletePhase, deleteSubphase } from '@/api';
...
export function ContextMenuContainer() {
  ...
  const getMenuItems = useCallback((): ContextMenuItem[] => {
    ...
    return [];
  }, [contextMenu, findTarget, canEdit, openProjectModal, openPhaseModal, openSubphaseModal, openModal, loadAllData]);
