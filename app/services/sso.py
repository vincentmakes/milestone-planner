...
class SSOService:
        ...
        if tenant and tenant.organization_id and tenant.organization:
            ...
            if org.sso_config and org.sso_config.is_enabled and org.sso_config.is_configured:
                ...
                return {
                    ...
                    "client_secret": decrypt(config.client_secret_encrypted) if config.client_secret_encrypted else None,
        ...
        async with httpx.AsyncClient() as client:
            while url and len(group_ids) < max_groups:
                ...
                if response.status_code != 200:
                    ...
                    print(f"Warning: Failed to fetch groups: {response.status_code} {response.text}")
                    break
    ...
    def build_authorization_url(
        ...
        state: str,
        include_groups_scope: bool = False
    ) -> str:
        """
