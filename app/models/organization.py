...
class Organization(MasterBase):
    ...
    tenants = relationship(
        "Tenant", back_populates="organization", foreign_keys="Tenant.organization_id"
    )
    ...
    def has_sso_configured(self) -> bool:
        ...
        return (
            self.sso_config is not None
            and self.sso_config.enabled == 1
            and self.sso_config.is_configured
        )
